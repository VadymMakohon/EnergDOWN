const model = {
  ...
  comments: [
    ...
    { userId: 1, friendId: 1, comment: 'Stå på, du klarer dette!' },
    { userId: 1, friendId: 3, comment: 'Inspirerende fremgang!' },
    { userId: 1, friendId: 5, comment: 'Imponerende innsats!' },
    { userId: 2, friendId: 2, comment: 'Bra fokus på målene!' },
    { userId: 2, friendId: 1, comment: 'Hold deg motivert!' },
    { userId: 2, friendId: 3, comment: 'Du er på rett vei!' },
    { userId: 2, friendId: 5, comment: 'Imponert over innsatsen din!' },
    { userId: 3, friendId: 2, comment: 'Fortsett det gode arbeidet!' },
    { userId: 3, friendId: 1, comment: 'Motivasjonen din inspirerer!' },
    { userId: 3, friendId: 3, comment: 'God progresjon!' },
    { userId: 3, friendId: 5, comment: 'Veldig bra innsats!' },
    { userId: 4, friendId: 2, comment: 'Kjempebra måloppnåelse!' },
    { userId: 4, friendId: 1, comment: 'Fortsett med de gode vanene!' },
    { userId: 4, friendId: 3, comment: 'Veldig imponerende!' },
    { userId: 4, friendId: 5, comment: 'Så inspirerende å se!' },
    { userId: 5, friendId: 2, comment: 'Du er virkelig dedikert!' },
    { userId: 5, friendId: 1, comment: 'Bra jobbet med progresjonen din!' },
    { userId: 5, friendId: 3, comment: 'Hold fokus, du er på vei!' },
    { userId: 5, friendId: 5, comment: 'Veldig bra, fortsett sånn!' },
  ],
