const model = {
  ...
  comments: [
    ...
    { userId: 1, friendId: 3, comment: 'Kommentar 3' },
    { userId: 1, friendId: 5, comment: 'Kommentar 4' },
    { userId: 2, friendId: 2, comment: 'Kommentar 1' },
    { userId: 2, friendId: 1, comment: 'Kommentar 2' },
    { userId: 2, friendId: 3, comment: 'Kommentar 3' },
    { userId: 2, friendId: 5, comment: 'Kommentar 4' },
    { userId: 3, friendId: 2, comment: 'Kommentar 1' },
    { userId: 3, friendId: 1, comment: 'Kommentar 2' },
    { userId: 3, friendId: 3, comment: 'Kommentar 3' },
    { userId: 3, friendId: 5, comment: 'Kommentar 4' },
    { userId: 4, friendId: 2, comment: 'Kommentar 1' },
    { userId: 4, friendId: 1, comment: 'Kommentar 2' },
    { userId: 4, friendId: 3, comment: 'Kommentar 3' },
    { userId: 4, friendId: 5, comment: 'Kommentar 4' },
    { userId: 5, friendId: 2, comment: 'Kommentar 1' },
    { userId: 5, friendId: 1, comment: 'Kommentar 2' },
    { userId: 5, friendId: 3, comment: 'Kommentar 3' },
    { userId: 5, friendId: 5, comment: 'Kommentar 4' },
  ],
